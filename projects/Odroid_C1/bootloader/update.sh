...
rm $BOOT_ROOT/INITRD
cp $UPDATE_DIR/INITRD $BOOT_ROOT/INITRD
...
if [ -f $SYSTEM_ROOT/usr/share/bootloader/u-boot -a -f $SYSTEM_ROOT/usr/share/bootloader/bl1 -a ! -e /dev/system -a ! -e /dev/boot ]; then
